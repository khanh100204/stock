...
import (
	"flag"
	"fmt"
	"stockcheck/pkg/calculations"
	"stockcheck/pkg/keyfile"
	"stockcheck/pkg/managefile"
	"stockcheck/pkg/prompts"
	"stockcheck/pkg/stockdata"
	"stockcheck/pkg/watchlist"
	"strings"
	"time"
)
...
func main() {
	...
	if stockTicker == "" && sector == "" && !getWatchlist {
		prompts.ShowMenu()
	}
	if getWatchlist {
